...
namespace BlazorGalaga.Static.Levels
{
    public static class Level8
    {
        public static void InitIntro(AnimationService animationService, int introspeedincrease)
        {
            ...
            for (int i = 0; i < 4; i++)
                animationService.Animatables.Add(BugFactory.CreateAnimatable_BugIntro(i, i * Constants.BugIntroSpacing, new Challenge1(), Sprite.SpriteTypes.RedBug,1, introspeedincrease, false));
            for (int i = 0; i < 4; i++)
